...
window.addEventListener("load", function () {
  ...
  function checkInput() {
    ...
    if (heightStr.length === 0) {
      ...
      buttonEnabled = false;
      heightInputMsg.textContent = "身長には数値入力";
    } else if (height <= 0) {
      buttonEnabled = false;
      heightInputMsg.textContent = "身長には正数入力";
    } else {
    ...
    if (weightStr.length === 0) {
      ...
      buttonEnabled = false;
      weightInputMsg.textContent = "体重には数値を入力";
    } else if (weight <= 0) {
      buttonEnabled = false;
      weightInputMsg.textContent = "体重には正数を入力";
    } else {
